...
p.resetJointState(RobotId, 0, 0.0, targetVelocity=0.0)
p.resetJointState(RobotId, 1, 0.0, targetVelocity=0.0)  # -np.pi/8
p.resetJointState(RobotId, 2, 0.0, targetVelocity=0.0)  # np.pi/4
p.resetJointState(RobotId, 4, 0.0, targetVelocity=0.0)
p.resetJointState(RobotId, 5, 0.0, targetVelocity=0.0)  # np.pi/8
p.resetJointState(RobotId, 6, 0.0, targetVelocity=0.0)  # np.pi/4
